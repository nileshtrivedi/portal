defmodule StudioWeb.Router do
  ...
  scope "/", StudioWeb do
    ...
    live "/fields", FieldLive.Index, :index
    live "/fields/new", FieldLive.Index, :new
    live "/fields/:id/edit", FieldLive.Index, :edit

    live "/fields/:id", FieldLive.Show, :show
    live "/fields/:id/show/edit", FieldLive.Show, :edit

    live "/portals", PortalLive.Index, :index
    live "/portals/new", PortalLive.Index, :new
    live "/portals/:id/edit", PortalLive.Index, :edit

    live "/portals/:id", PortalLive.Show, :show
    live "/portals/:id/show/edit", PortalLive.Show, :edit
